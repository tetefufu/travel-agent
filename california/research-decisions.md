...
**Sequence:** SUPERSEDED 2026-09-22 — Vegas dropped entirely (no EDC, no Coachella). Trip is now **Dubai → San Francisco (direct) → coastal road trip → Bora Bora**. Everything below in "Vegas Option" and the SFO/Napa/Big Sur/LA/San Diego route structure is superseded — see `bora bora/research-decisions.md` for the current sequence and `bora-bora.html` for the locked 17-day itinerary (4 nights SF, 1 night Carmel/Big Sur, 1 night Santa Barbara, 3 nights LA, 5 nights Bora Bora).
**Status:** SUPERSEDED 2026-09-22 (was already mid-restructure since 2026-09-20). Do not treat this file's route/Vegas detail as current — kept only for the DXB–SFO flight research (still valid) and driving-distance data (still useful for the coastal leg).
**Dates:** No longer date-locked — the Vegas/EDC/Eid-al-Adha window that drove the old May 17–26 dates no longer applies. See `bora bora/research-decisions.md` for current date status.

---

## Restructure — Decisions Made 2026-09-20

- **Duration:** 9 days California (was 7 days/6 nights)
- **Regions:** SFO/Napa area + LA/San Diego area — user asked if 2 hotels (one near SFO, one near LA) is enough
- **Verdict on 2 vs 3 hotels:** 2 is too few. SFO-area → LA-area direct is **~8h30–8h45 driving** (see distances below), too much for one day with Big Sur sightseeing in between. **Recommend 3 bases**: SFO/Napa, Big Sur (1 night, short stopover), LA/San Diego.
- **San Diego:** likely a day trip from LA base rather than a separate hotel, given it's only ~2–2.5h from LA (TBD — could also be a 1-night add if pace allows)
- **To-do:** check in with friends in California (optional, casual — not a itinerary-driving factor)
- **Hollywood Sign / LA:** still planned as a stop (see earlier decision — was going to be day-trip-only from Big Sur, now easier since LA is a proper base, not a rushed drive-through day)

## Driving Distances (estimates, non-rush-hour, verify closer to booking)

| Leg | Distance | Drive time |
|---|---|---|
| SFO Airport → Napa Valley (single hotel base) | 65 mi | ~1h20 |
| SFO/SF → Big Sur (direct, skipping Napa) | 150 mi | ~2h45–3h |
| Big Sur → Los Angeles | 305 mi | ~5h45 (longest leg in original 2-base plan) |
| **SFO → LAX total, via Big Sur, continuous** | ~455 mi | **~8h30–8h45** |
| Los Angeles → San Diego | 120 mi | ~2h–2h30 |
...
- Other April/May 2027 EDM-adjacent events found: Coachella — **dates officially confirmed** (Pollstar, announced 2026-04-20): Weekend 1 Apr 9–11, Weekend 2 Apr 16–18, 2027, Empire Polo Club, Indio — outside the May Eid window, so not in scope for this trip. Lightning in a Bottle (May 26–30, Buena Vista Lake — after the Eid window)
